...
The second milestone exposes the deterministic engine through a versioned
FastAPI service and a responsive browser workspace. The web layer displays
verified chart facts; it does not add predictions or AI calculations.
...
```console
docker build -t nakshatra-ai:0.2.0 .
docker run --rm -p 8000:8000 nakshatra-ai:0.2.0
```
